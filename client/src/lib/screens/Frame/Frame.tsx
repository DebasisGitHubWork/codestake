              ...
              >
                ...
                <Card
                  ...
                  className={`relative w-[340px] ${
                    ...
                    plan.popular 
                      ? "border-purple-500/30 after:absolute after:inset-0 after:rounded-xl after:shadow-[0_8px_60px_rgba(147,51,234,0.3),0_12px_90px_rgba(147,51,234,0.2)] after:-z-10" 
                      : "border-gray-800/30"
                  } rounded-xl overflow-hidden will-change-transform hover:shadow-[0_20px_80px_rgba(147,51,234,0.2),0_30px_120px_rgba(147,51,234,0.15)] hover:translate-y-[-4px]`}
                  style={{
                    transformStyle: 'preserve-3d',
                    boxShadow: plan.popular 
                      ? '0 4px 20px rgba(147,51,234,0.15), 0 8px 40px rgba(147,51,234,0.1)' 
                      : '0 4px 15px rgba(0,0,0,0.1), 0 8px 30px rgba(0,0,0,0.05)'
                  }}
                >
                  {plan.popular && (
                    <>
                      <div className="absolute -inset-[1px] rounded-xl bg-gradient-to-b from-purple-500/30 via-purple-500/15 to-transparent blur-sm" />
                      <div className="absolute -inset-[1px] rounded-xl bg-gradient-to-b from-purple-500/20 via-purple-500/10 to-transparent" />
                      <Badge className="absolute top-4 right-4 px-3 py-1 bg-purple-600 text-white text-xs font-semibold z-10 shadow-[0_2px_10px_rgba(147,51,234,0.3)]">
                        POPULAR
                      </Badge>
                    </>
                  )}
