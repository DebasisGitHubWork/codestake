      ...
      <header className="relative flex items-center justify-between w-full h-[72px] px-4 animate-fadeIn z-50">
        ...
        <div className="flex items-center gap-4">
          {user ? (
            <>
              <Link to="/challenges">
                <Button className="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 transition-all duration-300 hover:scale-[1.02] transform-gpu hover:translate-z-20">
                  Challenges
                </Button>
              </Link>
              <Link to="/dashboard">
                ...
                <Card
                  ...
                  className={`relative w-[340px] ${
                    ...
                    plan.popular 
                      ...
                      : "border-gray-800/40"
                  } rounded-xl overflow-hidden will-change-transform hover:shadow-[0_25px_90px_rgba(147,51,234,0.25),0_35px_130px_rgba(147,51,234,0.2)] hover:translate-y-[-4px]`}
                  style={{
                  ...
                  <CardFooter className="px-6 pb-8">
                    <Button
                      ...
                      className={`w-full py-6 text-base font-semibold transition-all duration-300 ${
                        plan.popular
                          ? "bg-purple-600 hover:bg-purple-700 text-white shadow-[0_8px_25px_rgba(147,51,234,0.3)] hover:shadow-[0_12px_30px_rgba(147,51,234,0.4)] hover:translate-y-[-1px]"
                          : "bg-gray-800/50 hover:bg-gray-700 text-white hover:shadow-[0_8px_20px_rgba(0,0,0,0.15)] hover:translate-y-[-1px]"
                      }`}
                    >
                      {plan.buttonText}
                    </Button>
